      ...
      <?php
        ...
        while($fila=$resultado->fetch_assoc())
        {
          echo "<tr>";
            ...
            echo "<td><a href='modif_prod1.php?no=".$fila['no']."'> <button type='button' class='btn btn_sucess'>Modificar</button></a></td>";
            echo "<td><a href='eliminar_prod.php?no=".$fila['no']."''> <button type='button' class='btn btn_danger'>Eliminar</button></a></td>";
          echo "</tr>";
        }
      ?>
